	...
	public static void main(String[] args) {
		...
		while(op) {
			...
			case 1: System.out.print("아이디 >> ");
					...
					while(op1) {
							...
							case 1: 
									...
									while(op2) {
										...
										case 2: boolean op3 = true;
												while(op3) {
													System.out.println("========== Breed ===========");
													System.out.println("뒤로가기는 숫자 1 번");
													System.out.println("============================");
													System.out.print("검색할 품종을 선택 하세오 >> ");
													...
													if(breed.equals("1")) {
															...
															System.out.println("Re-enter the breed name.");
													}
					...
					break;
			case 2: System.out.println("회원정보 입력");
					...
					if(adminId.equals("admin")) {
						while(op2) {
							...
							case 2: System.out.print("수정할 유기견 공고번호(ID) >> ");
									...
									break;
							case 3: System.out.print("수정할 유기견 공고번호(ID) >> ");
